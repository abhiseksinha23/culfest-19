...
.nav-pills > li > a.active {
    background-color: #321403!important;
...
<div class="container">
  <br><br>
     <img   src="heading/schedule.png" style="width: 100%;">
 <br>
  <br>
  <!-- Nav pills -->
  <ul class="nav nav-pills nav-justified "  role="tablist">
    <li class="nav-item">
      <a class="nav-link active" data-toggle="pill" href="#day1">Day 1</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="pill" href="#day2">Day 2</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="pill" href="#day3">Day 3</a>
    </li>
  </ul>
